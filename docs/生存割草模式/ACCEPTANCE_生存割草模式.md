...
## 五、grill-me 界面交互审查 (2026-06-11)

### P0 缺陷

| # | 问题 | 影响 |
|:--:|------|------|
| P0-1 | UpgradeUI 的 A/S/D 键映射冲突 | 游戏中 S=向下移动，升级界面 S=选择第二个技能，认知冲突 |
| P0-2 | 各界面确认行为不一致 | Menu/UpgradeUI 一点就触发，CharacterSelect/WeaponSelect 点两次，SaveLoad 点了还要 Enter |

**修复**: 见 [FINAL_生存割草模式.md](./FINAL_生存割草模式.md) 第六章。

### P1 缺陷

| # | 问题 | 影响 |
|:--:|------|------|
| P1-1 | GameOver 使用原生 QMessageBox | 破坏像素风沉浸感 |
| P1-2 | UpgradeUI 无法跳过/取消 | 强制选择，无 Esc 退出 |
| P1-3 | 导航键方向不统一 | UpgradeUI 同时支持 A/D 和方向键，但 A/D 被映射为选项快捷键 |
| P1-4 | SaveLoadUI 空槽静默失败 | 选中空槽按 Enter 无任何反馈 |

---

**文档状态**: ✅ V3.0 — P0 已修复，P1 待处理
